 class EventsController < ApplicationController
  ...
  private
    ...
    def event_params
      ...
      params.require(:event).permit(:name, :description, :notes, :start, :start_day, :start_time_12, :start_time_p, :duration, :finish, :equipment_set_id, :coordinator_id, :notify_of_changes, :status, :address, :lat, :lng, :hide_specific_location, :min, :max, :ward_id, tree_ids: [])
    end
